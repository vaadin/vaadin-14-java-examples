 ...
 */
@PWA(name = "Vaadin 14 Java Examples", shortName = "Vaadin 14 Java Examples", enableInstallPrompt = false)
@Push
@Theme(themeFolder = "vaadin14javaexamples")
public class MainLayout extends AppLayout {
    ...
    private Component createDrawerContent() {
        H2 appName = new H2("Vaadin 14 Java Examples");
